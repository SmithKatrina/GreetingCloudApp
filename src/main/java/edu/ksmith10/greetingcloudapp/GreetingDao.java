...
/**
 * Data Access Object - provide some specific data operations without exposing details of
 * the database * Access data for the Greeting entity. * Repository annotation allows Spring
 * to find and configure the DAO. * Transactional annonation will cause Spring to call
